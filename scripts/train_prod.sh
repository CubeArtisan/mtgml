...
python -m mtgml.training.train_combined --name train_prod --epochs 16 --seed 268459 || true
...
python -m mtgml.training.train_combined --name train_prod --epochs 16 --seed 16809
