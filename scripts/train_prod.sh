...
python -m mtgml.training.train_combined --name train_prod --epochs 1000 --seed 268459 --time 120
...
docker-compose -f .docker/docker-compose.yml build && docker-compose -f .docker/docker-compose.yml push
