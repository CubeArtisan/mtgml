...
class MLP(ConfigurableLayer):
    ...
    def get_properties(cls, hyper_config, input_shapes=None):
        num_hidden = hyper_config.get_int(
            "num_hidden", min=0, max=8, default=1, help="The number of hidden layers in the MLP."
        )
        props = {
            "hiddens": tuple(
            ...
            "final": hyper_config.get_sublayer(
                "Final", sub_layer_type=WDense, seed_mod=19, help="The last dense layer in the MLP."
            ),
