...
class ContextualRating(ConfigurableLayer):
    ...
    def get_properties(cls, hyper_config, input_shapes=None):
        ...
        embed_item = hyper_config.get_sublayer('EmbedItem', sub_layer_type=MLP, seed_mod=71,
        ...
        project_context = hyper_config.get_sublayer('ProjectContext', sub_layer_type=WDense, seed_mod=93,
