...
def get_card_maps(map_file):
    ...
    return (num_cards, name_lookup, card_to_int, int_to_card)
...
def build_cubes(cube_folder, num_cubes, num_cards, card_to_int, validation_func=always_true):
...
def build_decks(cube_folder, num_decks, num_cards, card_to_int, validation_func=always_true, soft_validation=0):
...
def build_mtx(deck_folder, num_cards, card_to_int, validation_func=always_true, soft_validation=0):
