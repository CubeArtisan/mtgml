...
write_html(
    fig,
    "card_embeddings_umap.html",
    auto_open=True,
    config={"responsive": True},
    include_plotlyjs="cdn",
    post_script=CARD_ADDED_JS,
)
...
write_html(
    fig,
    "cube_embeddings_tsne.html",
    auto_open=True,
    config={"responsive": True},
    include_plotlyjs="cdn",
    post_script=CUBE_ADDED_JS,
)
reduced = hyp.reduce(embeddings, ndims=2, reduce="UMAP")
df["x"] = reduced[:, 0]
df["y"] = reduced[:, 1]
